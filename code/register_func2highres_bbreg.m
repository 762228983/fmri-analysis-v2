...
if ~exist(exfunc2highres_bbreg_dat, 'file') || optInputs(varargin, 'overwrite')
...
if ~exist(exfunc2highres_bbreg_mat, 'file') || optInputs(varargin, 'overwrite')
...
if ~exist(exfunc2highres_bbreg_nifti, 'file') || optInputs(varargin, 'overwrite')
